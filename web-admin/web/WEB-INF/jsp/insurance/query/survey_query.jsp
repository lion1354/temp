		...
		<div class="form-group">
			<table>
				...
				<tr>
					...
					<td width="8%" class="left_txt3">查勘单状态</td>
...
<table id='tableSurvey' data-toggle="table" data-url="${ROOT}/insurance/accident/survey-query/2" data-toolbar="#table-toolbar" data-query-params="setQueryParameters" data-sort-name="id" data-sort-order="desc">
	<thead>
	<tr>
...
function search()
{
	tableSurvey.bootstrapTable('refresh');
}
...
{
	var html = '';
	html += '<a href="${ROOT}/accident/view-survey/' + val + '">查看</a>';
	if(r.approvalStatus == 0  || r.approvalStatus == 1)
	{
		...
		html += '<a href="${ROOT}/accident/survey/' + val + '">编辑</a>';
	}
