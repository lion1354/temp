package com.popular.common.sms;
...
public class SmsUtil {
	...
	public static String requestData(String address, String params) {
		...
		try {
			...
			if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
				String result = StringUtils.convertStreamToString(conn.getInputStream());
				return result;
			} else {
	...
	public static void main(String[] args) throws Exception {
		...
		String result = requestData("https://webapi.sms.mob.com/sms/verify",
				"appkey=153434de719bf&amp;phone=13572477846&amp;zone=86&amp;&amp;code=8710");
