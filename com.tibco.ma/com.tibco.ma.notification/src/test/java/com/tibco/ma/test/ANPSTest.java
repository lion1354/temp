...
public class ANPSTest {
	public static void main(String[] args) {
		String deviceToken = "557a4181f525202866e69441375c48601f22b40838e0596952857c620d18f3eb";
		String alert = "test2222";// push的内容
		int badge = 100;// 图标小红圈的数值
		String sound = "default";// 铃音

		List<String> tokens = new ArrayList<String>();
		tokens.add(deviceToken);
		String certificatePath = "D:/Certificates-Momento.p12";
		...
		try {
			...
			pushManager
					.initializeConnection(new AppleNotificationServerBasicImpl(
							file, certificatePassword, false));
			...
			System.out
					.println("failed:" + failed + ",successful:" + successful);
